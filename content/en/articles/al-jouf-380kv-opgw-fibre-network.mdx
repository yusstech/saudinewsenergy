...
seoDescription: >-
  The Al Jouf 380 kV line carries 110.21 km of optical ground wire on 279
  towers. How OPGW, teleprotection and SCADA let the grid see what happens
  along its route.
...
On the same contractor's [Tabuk 380 kV line](/en/article/tabuk-380kv-tower-types), the equivalent corridor needed six separate tower designs to carry it. The Al Jouf project combined several disciplines across the Tabarjal corridor:
