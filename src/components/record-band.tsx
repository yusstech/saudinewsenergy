 ...
 *
 * What is true is the project record. When the lead story is about a project, that record is the
 * most substantial thing the site can put on the front page: route length, structures and dates,
 * set out as the reporting establishes them. So the band renders that.
 *
